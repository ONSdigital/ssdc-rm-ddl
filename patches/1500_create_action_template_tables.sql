...
CREATE TABLE casev3.action_template_row (
    ...
    PRIMARY KEY (id),
    CONSTRAINT fk_action_template_row_action_template FOREIGN KEY (action_template_id) REFERENCES action_template (id),
    CONSTRAINT fk_action_template_row_email_template FOREIGN KEY (email_template_pack_code) REFERENCES email_template (pack_code)
);

ALTER TABLE IF EXISTS casev3.collection_exercise ADD COLUMN template_id uuid;
ALTER TABLE IF EXISTS casev3.collection_exercise ADD CONSTRAINT fk_collection_exercise_action_template FOREIGN KEY (template_id) REFERENCES action_template (id);