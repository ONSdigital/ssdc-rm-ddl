...
GRANT SELECT, INSERT, UPDATE, DELETE ON casev3.cases TO rm_app_user;
...
GRANT SELECT, INSERT, DELETE ON casev3.event TO rm_app_user;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON casev3.uac_qid_link TO rm_app_user;
