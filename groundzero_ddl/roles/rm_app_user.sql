...
GRANT SELECT, DELETE ON casev3.case_to_process TO rm_app_user;
...
GRANT INSERT  ON casev3.event TO rm_app_user;
...
GRANT SELECT, INSERT ON ALL TABLES IN SCHEMA uacqid TO rm_app_user;

GRANT SELECT ON ALL SEQUENCES IN SCHEMA casev3 TO rm_app_user;
GRANT SELECT ON ALL SEQUENCES IN SCHEMA uacqid TO rm_app_user;
GRANT SELECT ON ALL SEQUENCES IN SCHEMA exceptionmanager TO rm_app_user;
