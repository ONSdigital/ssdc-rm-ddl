...
INSERT INTO ddl_version.version (version_tag, updated_timestamp) VALUES ('v1.0.10', current_timestamp);
...
('NL_EN_ST_CRIS', 'CRIS Notification Letter - English', 'internal_reprographics', null ,'["PORTAL_ID","__sensitive__.ADDRESS_LINE_1","ADDRESS_LINE_2","ADDRESS_LINE_3","TOWN_NAME","POSTCODE","__sensitive__.LAST_NAME","FIRST_NAME","__uac__","COLLEX_OPEN_DATE","COLLEX_CLOSE_DATE"]'),
('NL_CY_ST_CRIS', 'CRIS Notification Letter - Bilingual Welsh', 'internal_reprographics', null , '["PORTAL_ID","__sensitive__.ADDRESS_LINE_1","ADDRESS_LINE_2","ADDRESS_LINE_3","TOWN_NAME","POSTCODE","__sensitive__.LAST_NAME","FIRST_NAME","__uac__","COLLEX_OPEN_DATE","COLLEX_CLOSE_DATE"]'),
('NL_EN_LP_CRIS', 'CRIS Notification Letter - English - Large Print', 'internal_reprographics', null ,'["PORTAL_ID","__sensitive__.ADDRESS_LINE_1","ADDRESS_LINE_2","ADDRESS_LINE_3","TOWN_NAME","POSTCODE","__sensitive__.LAST_NAME","FIRST_NAME","__uac__","COLLEX_OPEN_DATE","COLLEX_CLOSE_DATE"]'),
('NL_CY_LP_CRIS', 'CRIS Notification Letter - Bilingual Welsh - Large Print', 'internal_reprographics', null ,'["PORTAL_ID","__sensitive__.ADDRESS_LINE_1","ADDRESS_LINE_2","ADDRESS_LINE_3","TOWN_NAME","POSTCODE","__sensitive__.LAST_NAME","FIRST_NAME","__uac__","COLLEX_OPEN_DATE","COLLEX_CLOSE_DATE"]')
